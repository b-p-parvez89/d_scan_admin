...
class AddBestDoctor extends StatefulWidget {
  const AddBestDoctor({Key? key}) : super(key: key);

  @override
  State<AddBestDoctor> createState() => _AddBestDoctorState();
}

class _AddBestDoctorState extends State<AddBestDoctor> {
  ...
  void _addDoctor() async {
    ...
    if (nameByEnglish.isNotEmpty &&
      ...
      try {
        ...
        await FirebaseFirestore.instance.collection('best_doctor').add({
